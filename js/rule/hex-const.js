...
app.factory('rule', ['qCommon', function (qCommon) {
	 ...
	 * decor - 装飾用クラスリストの設定
	 ****************************************************************************/
	rule.decor = ["chance", "pinch", "up1", "up2", "up3", "up4", "up5", "up6", "up7", "up8"];
	...
	rule.actions = [
		 ...
		 ****************************************************************************/
		{
			...
			button_css: "btn btn-danger",
			enable0: function (player, players, header, property) {
				return enable00(7, player, players, header, property);
			},
			action0: function (player, players, header, property) {
				action00(7, player, players, header, property);
			}
		}, {
			name: 8,
			css: "action_sl" + 8,
			button_css: "btn btn-danger",
			enable0: function (player, players, header, property) {
				return enable00(8, player, players, header, property);
			},
			action0: function (player, players, header, property) {
				action00(8, player, players, header, property);
			}
		}
	];
